 ...
 * @LastEditors: yumu
 * @LastEditTime: 2020-12-21 17:56:42
 * @Description: 
 */
	...
	if ($_POST['trade_status'] === "TRADE_SUCCESS") {
		...
		if (NeedTakeNote == "yes") {
			...
			if ($res === "nopay") {
				...
				//@file_get_contents('https://sc.ftqq.com/YourFtqqKey.send?text='.urlencode('打赏成功通知').'&desp='.urlencode("收到来自 {$buyer_logon_id} 的打赏，金额为 {$mount}"));
			}
		}
	}
} else {
